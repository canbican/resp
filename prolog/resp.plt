...
resp_test_case(writef('*-1\r\n',[]),[array(nil)]).
resp_test_case(writef('*0\r\n',[]),[array([])]).
resp_test_case(writef('*2\r\n$3\r\nfoo\r\n$3\r\nbar\r\n',[]),[array([bulk("foo"),bulk("bar")])]).
resp_test_case(writef('*3\r\n:1\r\n:2\r\n:3\r\n',[]),[array([integer(1),integer(2),integer(3)])]).
resp_test_case(writef('*5\r\n:1\r\n:2\r\n:3\r\n:4\r\n$6\r\nfoobar\r\n',[]),[array([integer(1),integer(2),integer(3),integer(4),bulk("foobar")])]).
resp_test_case(writef('*2\r\n*3\r\n:1\r\n:2\r\n:3\r\n*2\r\n+Foo\r\n-Bar\r\n',[]),[array([array([integer(1),integer(2),integer(3)]),array([string('Foo'),error('Bar')])])]).
resp_test_case(writef('*3\r\n$3\r\nfoo\r\n$-1\r\n$3\r\nbar\r\n',[]),[array([bulk("foo"),bulk(nil),bulk("bar")])]).
resp_test_case(writef('*3\r\n$3\r\nfoo\r\n$17\r\n你好！\n 换行\r\n$3\r\nbar\r\n',[]),[array([bulk("foo"),bulk("你好！\n 换行"),bulk("bar")])]).
